...
const LanguageSelector = () => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-full bg-white px-3 py-2 text-sm font-semibold text-gray-900 border-2 border-black dark:border-transparent hover:bg-gray-50">
          Language
          <ChevronDownIcon
