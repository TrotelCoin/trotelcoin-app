  ...
  return (
    <Fade>
      ...
      <div className="flex justify-center mx-4 lg:mx-10 my-20 overflow-hidden">
        ...
        <div className="bg-gray-50 border-2 border-gray-900/10 dark:border-gray-100/10 text-center shadow rounded-xl p-10 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
