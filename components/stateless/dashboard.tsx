  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mx-4 lg:mx-10 my-8 overflow-hidden">
        {/* Progression card */}
        <Fade>
          <div className="bg-yellow-200 border-2 border-transparent hover:border-gray-900/50 hover:border-2 dark:text-gray-700 text-gray-700 lg:col-span-3 text-center rounded-xl p-10 dark:bg-yellow-100">
        ...
        {/* Courses taken card */}
        <Slide left>
          <div className="bg-gray-50 border-2 border-gray-900/10 dark:border-gray-100/10 hover:border-gray-900/50 dark:hover:border-gray-100/50 dark:text-gray-300 text-gray-700 text-center rounded-xl p-10 dark:bg-gray-800">
        ...
        {/* Trotel balance card */}
        <Slide right>
          <div className="bg-gray-50 border-2 border-gray-900/10 dark:border-gray-100/10 hover:border-gray-900/50 dark:hover:border-gray-100/50 dark:text-gray-300 text-gray-700 text-center rounded-xl p-10 lg:col-span-2 dark:bg-gray-800">
            <span className="text-4xl lg:text-8xl text-gray-900 dark:text-yellow-100">
              <TrotelBalanceNoSSR />
