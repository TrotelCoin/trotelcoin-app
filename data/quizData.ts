const quizzes = [
  {
    ...
    questions: [
      ...
      {
        questionId: 2,
        question: "What's the utility of the TrotelCoin token?",
        options: [
      ...
      {
        questionId: 3,
        question: "Why can't I use the platform without a wallet?",
        options: [
      ...
      {
        questionId: 4,
        question: "What's the purpose of the TrotelCoin DAO?",
        options: [
      ...
      {
        questionId: 5,
        question: "Why should I use TrotelCoin?",
        options: [
      ...
      {
        questionId: 6,
        question: "Must I buy TrotelCoin to learn?",
        options: [
          "Yes, it's mandatory",
