const quizzes = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: {
          en: [
            "Users answer the questionnaire once, and captcha prevents bot spam.",
          ...
          fr: [
            "Les utilisateurs répondent au questionnaire une seule fois, et le captcha empêche le spam de bot.",
