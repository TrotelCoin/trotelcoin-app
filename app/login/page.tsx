      ...
      <div className="flex min-h-full mt-20 flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link
                    href="/forgotPassword"
                    className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-200 dark:hover:text-blue-100"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  placeholder="••••••••••••••••"
                  className="block w-full rounded-md border-0 px-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6"
                />
              </div>
            </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-900 dark:text-gray-100">
            ...
            <Link
              href="/signup"
              className="font-semibold leading-6 text-blue-600 hover:text-blue-500 dark:text-blue-200 dark:hover:text-blue-100"
            >
              Sign up
            </Link>
          </p>
