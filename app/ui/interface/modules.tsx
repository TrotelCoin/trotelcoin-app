...
export default function Modules() {
  ...
  return (
    <div className="lg:mx-10 mx-4 my-8">
      <div className="border-2 border-gray-900/10 dark:border-gray-100/10 rounded-xl bg-white dark:bg-gray-900 px-10 py-5 overflow-hidden animate__animated animate__fadeIn">
