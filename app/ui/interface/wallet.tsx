            ...
            {({ open }) => (
              <>
                ...
                >
                  <Menu.Items
                    static
                    className="absolute divide-y divide-gray-900/10 dark:divide-gray-100/10 mt-4 left-0 bg-white dark:bg-slate-800 border border-gray-900/10 dark:border-gray-100/10 rounded-lg"
                  >
