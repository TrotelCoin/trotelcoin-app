...
import { Article, ArticleCardProps } from "@/types/types";
...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, onOpen }) => {
  ...
  return (
    <div
      className="bg-white rounded-xl overflow-hidden hover:cursor-pointer border-2 border-gray-900/10 dark:border-gray-100/10 dark:bg-gray-900 hover:border-gray-900/50 dark:hover:border-gray-100/50"
    ...
    >
      <div className="p-6">
        ...
        <div className="flex-wrap flex items-center mt-4 gap-4">
          ...
          <div className="text-gray-900 text-xs px-3 py-1 bg-blue-200 dark:bg-blue-100 rounded-full text-center">
            {article.category}
          </div>
