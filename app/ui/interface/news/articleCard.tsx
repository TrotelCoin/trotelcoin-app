...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, onOpen }) => {
  ...
  return (
    <div
      className="bg-white rounded-xl overflow-hidden hover:cursor-pointer border backdrop-blur-xl border-gray-900/10 dark:border-gray-100/10 dark:bg-gray-900 hover:border-gray-900/50 dark:hover:border-gray-100/50"
