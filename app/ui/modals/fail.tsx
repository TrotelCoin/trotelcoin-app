    ...
    <Transition.Root show={show} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 backdrop-blur-sm bg-white/10 dark:bg-black/10 transition-opacity" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-xl backdrop-blur-xl border border-stone-900/10 dark:border-stone-100/10 bg-white dark:bg-black px-4 pb-4 pt-5 text-left transition-all my-8 w-full max-w-sm p-6">
                <div>
