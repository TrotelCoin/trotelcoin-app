...
import { Badges, DictType, Lang } from "@/types/types";
  ...
  const badges: Badges = {
    ...
    staking: [
      ...
      },
      {
        id: 20,
        name:
          lang === "en" ? "1k locked TrotelCoins" : "1k TrotelCoins bloqués",
        image: "🐠",
      ...
      },
      {
        ...
        name:
          lang === "en"
            ? "100k locked TrotelCoins"
            : "100k TrotelCoins bloqués",
        image: "🦈",
      ...
      },
      {
        id: 23,
        name:
          lang === "en" ? "1M locked TrotelCoins" : "1M TrotelCoins bloqués",
        image: "🐳",
