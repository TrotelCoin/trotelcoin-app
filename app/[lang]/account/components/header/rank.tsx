...
const Rank = ({ lang }: { lang: Lang }) => {
  ...
  return (
    <>
      <div
        className={`col-span-2 md:col-span-3 bg-blue-500 shadow h-full flex items-center justify-center backdrop-blur-xl text-center rounded-xl px-2 py-10 text-gray-100`}
      >
