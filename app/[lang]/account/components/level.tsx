...
const LevelSection: React.FC<LevelSectionProps> = ({ dict }) => {
  ...
  return (
    <>
      ...
      <div
        className={`mt-4 bg-gray-100 flex flex-col border backdrop-blur-xl border-gray-900/10 dark:border-gray-100/10 text-center rounded-lg p-10 dark:bg-gray-800 text-gray-900 dark:text-gray-100`}
      >
