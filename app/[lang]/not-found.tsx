      ...
      <main className="grid min-h-full place-items-center bg-white dark:bg-black px-6 py-48 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href={`/en/home`}
              className="rounded-md bg-yellow-500 dark:bg-yellow-300 px-3.5 py-2.5 text-sm font-semibold text-gray-900 dark:text-gray-900 shadow-sm hover:bg-yellow-400 dark:hover:bg-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-500"
            >
              Go back home
            </Link>
          </div>
