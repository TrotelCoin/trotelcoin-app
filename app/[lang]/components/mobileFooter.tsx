...
const MobileFooter = ({ lang }: { lang: Lang }) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`md:hidden fixed bottom-0 left-0 w-full bg-gray-100 dark:bg-gray-800 pt-4 pb-6 px-6 shadow-xl border-t border-gray-900/20 dark:border-gray-100/20`}
        >
