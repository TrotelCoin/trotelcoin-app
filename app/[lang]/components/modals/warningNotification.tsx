      ...
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-start">
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className="pointer-events-auto w-full max-w-sm overflow-hidden rounded-xl bg-gray-50 dark:bg-gray-900 shadow border border-gray-900/10 dark:border-gray-100/10">
              <div className="p-4">
