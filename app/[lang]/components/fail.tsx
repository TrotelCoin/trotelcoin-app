      ...
      <Dialog as="div" className="fixed inset-0 flex z-50 items-center justify-center h-screen m-auto" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-50 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-xl backdrop-blur-xl border border-gray-900/20 dark:border-gray-100/20 bg-white dark:bg-gray-900 px-4 pb-4 pt-5 text-left transition-all my-8 w-full max-w-sm p-6">
                <div>
