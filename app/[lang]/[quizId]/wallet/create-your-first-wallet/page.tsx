      ...
      },
      {
        ...
        text: (
          <>
            ...
            d'interagir avec des applications décentralisées. Il est disponible
            en tant qu'extension de navigateur pour Chrome, Firefox et Brave.
            Pour configurer MetaMask, allez sur le site{" "}
            <Link
              className="text-blue-500 dark:text-blue-300 hover:text-blue-400 dark:hover:text-blue-400"
              href="https://metamask.io/"
              target="_blank"
      ...
      },
      {
        ...
        text: (
          <>
            ...
            , téléchargez l'application depuis l'App Store ou le Google Play
            Store et suivez les instructions pour créer un nouveau portefeuille.
          </>
        ),
      },
      {
        ...
        text: (
          <>
            ...
            en charge plein de blockchains et de fonctionnalités. Pour
            configurer{" "}
            <Link
              href="https://rabby.io/"
              target="_blank"
