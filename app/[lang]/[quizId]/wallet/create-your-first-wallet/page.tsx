  ...
  const cards = {
      ...
      },
      {
        ...
        text: (
          <>
            ...
            decentralized applications. It is available as a browser extension
            for Chrome, Firefox, and Brave. To set up MetaMask, go to the{" "}
            <Link
      ...
      },
      {
        ...
        text: (
          <>
            ...
            , download the app from the App Store or Google Play Store and
      ...
      },
      {
        ...
        text: (
          <>
            ...
            , go to the website and follow the instructions to purchase a
            device.
          </>
        )
      },
    ...
    fr: [
      ...
      },
      {
        ...
        text: (
          <>
            ...
            d&apos;interagir avec des applications décentralisées. Il est
            disponible en tant qu&apos;extension de navigateur pour Chrome,
            Firefox et Brave. Pour configurer MetaMask, allez sur le site{" "}
            <Link
              className="text-blue-500 hover:text-blue-400 dark:text-blue-300 dark:hover:text-blue-400"
              href="https://metamask.io/"
              target="_blank"
      ...
      },
      {
        ...
        text: (
          <>
            ...
            et d&apos;autres blockchains nativement. Il est disponible pour iOS
            et Android. Pour configurer{" "}
            <Link
              href="https://trustwallet.com/"
              target="_blank"
              className="text-blue-500 hover:text-blue-400 dark:text-blue-300 dark:hover:text-blue-400"
            ...
            , téléchargez l&apos;application depuis l&apos;App Store ou le
            Google Play Store et suivez les instructions pour créer un nouveau
            portefeuille.
          </>
        )
      },
      {
        ...
        text: (
          <>
            Rabby Wallet est un portefeuille web3 simple d&apos;utilisation qui
            prend en charge plein de blockchains et de fonctionnalités. Pour
            configurer{" "}
            <Link
              href="https://rabby.io/"
              target="_blank"
      ...
      },
      {
        ...
        text: (
          <>
            ...
            gamme de cryptomonnaies. Pour acheter une clé et la configurer,
            allez sur le site{" "}
            <Link
              href="https://www.ledger.com/"
              target="_blank"
      ...
      },
      {
        ...
        text: (
          <>
            Trezor est également un portefeuille matériel qui prend en charge
            une large gamme de cryptomonnaies. Pour acheter et configurer{" "}
            <Link
              href="https://trezor.io/"
              target="_blank"
              className="text-blue-500 hover:text-blue-400 dark:text-blue-300 dark:hover:text-blue-400"
