                    ...
                    <Tooltip.Root delayDuration={0}>
                      ...
                      <Tooltip.Portal>
                        <Tooltip.Content
                          ...
                          sideOffset={5}
                        >
                          <div className="max-w-xs text-sm text-gray-700 dark:text-gray-300 text-center flex shadow p-2 flex-col bg-gray-100 dark:bg-gray-800 border border-gray-900/10 dark:border-gray-100/10 backdrop-blur-xl rounded-xl">
                            {lang === "en"
                ...
                <Popover.Root>
                  ...
                  <Popover.Portal>
                    <Popover.Content
                      ...
                      sideOffset={5}
                    >
                      <div className="max-w-xl text-sm text-gray-700 dark:text-gray-300 text-center flex shadow p-2 flex-col bg-gray-100 dark:bg-gray-800 border border-gray-900/10 dark:border-gray-100/10 backdrop-blur-xl rounded-xl">
