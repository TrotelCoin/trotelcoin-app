      ...
      <div className="mx-auto max-w-md justify-center items-center">
        <div className="flex justify-center rounded-xl mx-auto">
          <iframe
            ...
            className="block max-w-md dark:hidden overflow-hidden border border-gray-900/10 dark:border-gray-100/10 rounded-xl bg-gray-50 dark:bg-gray-800"
          ...
          <iframe
            ...
            height="720"
            style={{ overflow: "hidden" }}
            className="hidden max-w-md dark:block overflow-hidden border border-gray-900/10 dark:border-gray-100/10 rounded-xl bg-gray-50 dark:bg-gray-800"
            allow="clipboard-read *; clipboard-write *; web-share *; accelerometer *; autoplay *; camera *; gyroscope *; payment *; geolocation *"
