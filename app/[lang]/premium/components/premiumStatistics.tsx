...
const PremiumStatistics = ({ dict }: { dict: DictType }) => {
  ...
  return (
    <>
      <div className="overflow-hidden grid grid-cols-1 md:grid-cols-3 mt-4 text-gray-900 dark:text-gray-100 items-center text-center md:divide-x md:divide-y-0 divide-x-0 divide-y divide-gray-900/20 dark:divide-gray-100/20 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-900/20 dark:border-gray-100/20 blackdrop-blur-xl">
